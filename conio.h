...
============ Source code ============
Link        :
https://raw.githubusercontent.com/ramadhinolfski/cpackets/master/conio.h GitHub
: https://github.com/zoelabbb/conio.h.git
=====================================
...
===============
  ...
  *Report bugs.
  ...
  For any case:
  Send a mail to pintocar83@gmail.com with the modifications and information:
...
public:
  ...
  void clrscr() { printf("\033[%dm\033[2J\033[1;1f", bgc); }
